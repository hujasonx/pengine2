...
// */
//public class PModelGenTemplateOld {
//  private static final PMap<String, PModelGenTemplateOld> staticTemplates = new PMap<>();
...
//
//  private PModelGenTemplateOld(String name) {
...
//  }
//
//  public static PModelGenTemplateOld get(String name) {
//    if (staticTemplates.has(name)) {
//      return staticTemplates.get(name);
//    }
//    PModelGenTemplateOld ret = new PModelGenTemplateOld(name);
...
//   */
//  public void emit(PModelGenOld modelGen, PModelGenTemplateOptionsOld options, PModelGenOld.Part basePart,
...
//      int idxOForPos = mesh.vertexAttributes().floatIndexForVertexAttribute(PVertexAttributes.Attribute.Keys.pos);
//      int idxOForNor = mesh.vertexAttributes().floatIndexForVertexAttribute(PVertexAttributes.Attribute.Keys.nor);
...
//     */
//    public void emit(PModelGenTemplateOptionsOld options, PModelGenOld.Part part,
...
//                int offsetI = mesh.vertexAttributes().floatIndexForVertexAttribute(va.alias);
