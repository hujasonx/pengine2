...
public class LasertagRoomGenWalkwayProcessorOld {
  ...
  private static class PossibleWalkwayLayout {
    ...
    public PList<WalkwayNode> getWalkwayNodes(PList<ConnectedGroup> connectedGroups) {
      ...
      return LasertagRoomGenWalkwayProcessorOld.getWalkwayNodes(tilesToProcess, connectedGroups);
    }
    ...
    private static class PossibleWalkwayPath {
       ...
       */
      void emit(LasertagRoomGenWalkwayProcessorOld.PossibleWalkwayLayout layout, PList<ConnectedGroup> connectedGroups) {
