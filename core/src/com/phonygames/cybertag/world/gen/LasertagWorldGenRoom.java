...
//    PModelGenOld.Part basePart = modelGen.addPart(partNamePrefix + "Part", PVertexAttributes.Templates.POS_NOR_UV0_COL0);
...
//      if (emitMesh) {
//        basePart.set(PVertexAttribute.Definitions.col[0].alias,
